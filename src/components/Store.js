...
import { Stack, Grid, Button, Flex, Text } from "@chakra-ui/react";
...
const Store = () => {
  ...
  const handleAddToCart = (product) => {
    setCart((cart) => {
      ...
      return [...cart, product]; /* Le devuelve este state al array  */
    });
  };
  ...
  return products ? (
    <>
      ...
      <CartDrawer
        items={cart}
        onIncrement={(product) => handleEditCartCantidad(product, "increment")}
        onDecrement={(product) => {
